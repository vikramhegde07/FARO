...
const Sidebar = ({ refresh }) => {
  ...
  return (
    <>
      <div
        className={`side-toggler d-block d-md-none m-1 ${
          navActive ? "change" : ""
        } `}
      >
        <button
          className="btn px-4 py-0 bg-light fs-4 rounded-0"
      ...
      <div
        className={`container-fluid bg-light px-0 sidebar py-3 flex-jbetween flex-column ${
          navActive ? "change" : ""
        }`}
      >
        <div className="container-fluid flex-acenter flex-column gap-2">
          ...
          <Link
            to={"/admin"}
            onClick={handleClick}
            className="w-100 py-2 ps-2 text-black text-decoration-none flex-acenter gap-2 fs-5 hover-bg-gray rounded-0"
          >
          ...
          >
            <img
              src="/assets/img/island-icon.png"
              alt=""
              width={16}
              height={16}
            />
        ...
        <div className="container-fluid flex-center flex-column gap-2">
          ...
          <button
            className="btn btn-danger w-100 flex-acenter gap-2 fs-5 rounded-0"
